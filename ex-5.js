...
for ( let i=0; i<orders.length; i++) {
  ...
  } else if ((orders[i].productPrice * orders[i].productQuantity) > mostExpensiveOrder) {
    orderID = orders[i].id;
    mostExpensiveOrder = orders[i].productPrice * orders[i].productQuantity;
  }
}
...
console.log("The most expensive order is order id " + orderID + " (" + mostExpensiveOrder + " Baht)");